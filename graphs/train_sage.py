...
def main(args):
    ...
    print(f'GRAPHSAGE Training time avg : {np.mean(train_dur):.6f} seconds | total: {sum(train_dur)} seconds')
    print(f'RANDOM STATE SPLIT : {args.rs}')
    print("============ Testing ========================")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--rs", type=int, default=42, 
                        help="random state for data split")
